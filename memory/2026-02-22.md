...
**Status:** Verfügbar, maximal iOS 9.3.5

### Einsatzzweck im Smart Home Setup
...
- Safari Browser öffnen → `http://homeassistant.local:8123`
...
**Nachteile:**
- Nur Home Assistant Web-Interface (keine native App möglich auf iOS 9)
